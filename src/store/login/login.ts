...
const login: Module<ILoginState, IRootState> = {
  ...
  state() {
    return {
      token:
        'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwibmFtZSI6ImNvZGVyd2h5Iiwicm9sZSI6eyJpZCI6MSwibmFtZSI6Iui2hee6p-euoeeQhuWRmCJ9LCJpYXQiOjE2NTgwNDEwMDAsImV4cCI6MTY2MDYzMzAwMH0.dxEW0kgBiOYk28rO1Ez3CvNpbJpR2EJuK8iZ0K_oKh39unrGXznLW93bl8oh3mfO1ei34p6LzSXT70_xrH1P82g_BXticI2A7ulOvLD4_UwREZd8iBeIPGBVpetFTTd3XBixC92iB_lyaTq7dBIDK35FpKH7la6ZqnpZ2ucChpg',
      userInfo: {},
      userMenus: {},
      permissions: []
    }
